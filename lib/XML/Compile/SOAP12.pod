...
See L<documentation in base class|XML::Compile::SOAP/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile::SOAP/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|XML::Compile::SOAP/"Constructors">.
...
See L<documentation in base class|XML::Compile::SOAP/"Accessors">.
...
See L<documentation in base class|XML::Compile::SOAP/"Single message">.
...
See L<documentation in base class|XML::Compile::SOAP/"Helpers">.
 
=head2 Transcoding

See L<documentation in base class|XML::Compile::SOAP/"Transcoding">.
...
See L<documentation in base class|XML::Compile::SOAP/"DETAILS">.
