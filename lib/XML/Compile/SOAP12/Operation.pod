...
XML::Compile::SOAP12::Operation-E<gt>B<new>(OPTIONS)
...
All OPTIONS besides those described here are passed to XML::Compile::SOAP12::Operation subroutine template,
...
XML::Compile::SOAP12::Operation-E<gt>B<register>(URI, ENVNS)
...
This module is part of XML-Compile-SOAP12 distribution version 2.01,
built on April 07, 2010. Website: F<http://perl.overmeer.net/xml-compile/>
