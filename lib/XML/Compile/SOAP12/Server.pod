...
See L<documentation in the base class|XML::Compile::SOAP12/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in the base class|XML::Compile::SOAP::Server/"METHODS">.
 
See L<documentation in the base class|XML::Compile::SOAP12/"METHODS">.
...
See L<documentation in the base class|XML::Compile::SOAP12/"DETAILS">.
 
=head1 SEE ALSO

This module is part of XML-Compile-SOAP12 distribution version 3.00,
