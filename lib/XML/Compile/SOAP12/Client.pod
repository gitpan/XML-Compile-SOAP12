...
See L<documentation in base class|XML::Compile::SOAP::Client/"DESCRIPTION">.
 
See L<documentation in base class|XML::Compile::SOAP12/"DESCRIPTION">.
 
=head1 METHODS

See L<documentation in base class|XML::Compile::SOAP::Client/"METHODS">.
 
See L<documentation in base class|XML::Compile::SOAP12/"METHODS">.
 
=head2 Constructors

See L<documentation in base class|XML::Compile::SOAP::Client/"Constructors">.
 
See L<documentation in base class|XML::Compile::SOAP12/"Constructors">.
...
See L<documentation in base class|XML::Compile::SOAP12/"Accessors">.
...
See L<documentation in base class|XML::Compile::SOAP12/"Single message">.
...
See L<documentation in base class|XML::Compile::SOAP12/"Helpers">.
 
=head2 Transcoding

See L<documentation in base class|XML::Compile::SOAP12/"Transcoding">.
...
See L<documentation in base class|XML::Compile::SOAP::Client/"Handlers">.
